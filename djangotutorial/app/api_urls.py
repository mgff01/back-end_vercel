...
from app.api import AlunoViewSet, ProfessorViewSet, CoordenadorViewSet, ModeloDocumentoViewSet, SolicitacaoEstagioViewSet, ParecerTecnicoViewSet, RelatorioViewSet, ApoliceViewSet, ContratoViewSet, AssinaturaDigitalViewSet
...
router.register(r'modelos-documentos', ModeloDocumentoViewSet, basename='modelo-documento')
